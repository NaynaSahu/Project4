...
String k = DataUtility.getString(request.getParameter("cname"));
System.out.println(k);

bean.setId(DataUtility.getLong(k));
// bean.setName(DataUtility.getString(request.getParameter("cname")));
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List list = null;
		System.out.println("Courselist ctl get");
		int pageNo = 1;
...
//		System.out.println("after delete wapas");
		List list;
		System.out.println("course list ctl post");
		...
		System.out.println("do post of course" + ids);
		try {
