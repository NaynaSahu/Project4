...
<!DOCTYPE html>
<%@page import="in.co.sunrays.proj4.servlet.TimeTableCtl"%>
...
<table>
 ...
 <tr><th style="padding: 3px"></th></tr>   
	...
	<td> <input type="text" readonly="readonly" id="udate5" size="24" placeholder="	Select Date" name="ExDate" value="<%=DataUtility.getDateString(bean.getExamDate()) %>">
