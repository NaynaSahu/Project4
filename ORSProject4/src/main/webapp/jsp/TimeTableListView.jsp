...
<%@page import="in.co.sunrays.proj4.servlet.TimeTableListCtl"%>
...
<body>
	...
	<form action="<%=ORSView.TIMETABLE_LIST_CTL%>" method="post">
		...
		<center>
			...
			<table width="100%">
				<tr>
					<td align="center"><label>Course Name :</label> <%=HTMLUtility.getList("clist", String.valueOf(bean.getCourseId()), cList)%>
						...
						readonly="readonly" id="udate6" placeholder="Select Date"
			...
			<br>
			<table border="1" width="100%" align="center" cellpadding=5px
				cellspacing="0">
				<tr align="center">
			...
			<table width="100%">
				<tr>
					...
					<td align="right"><input type="submit" disabled="disabled"
						name="operation" value="<%=TimeTableListCtl.OP_NEXT%>"></td>
					<%
					} else {
					%>
