...
<%@page import="in.co.sunrays.proj4.servlet.CourseCtl"%>
...
<body>
<jsp:useBean id="bean" class="in.co.sunrays.proj4.bean.CourseBean" scope="request"></jsp:useBean>
...
<table>
	...
	<td><input type="text" name ="name" placeholder="Enter Course Name" size="24" value="<%=DataUtility.getStringData(bean.getCourseName()) %>">
