...
<%@page import="in.co.sunrays.proj4.servlet.StudentListCtl"%>
	...
	int pageNo = ServletUtility.getPageNo(request);
            ...
            <table width="100%">
                <tr>
                    ...
                    <%=HTMLUtility.getList("stulist", String.valueOf(bean.getId()), stlist) %>
            ...
            <table border="1" width="100%" cellpadding="10" cellspacing="0">
                ...
                <td> <input type="checkbox" class="checkbox" name="ids" value="<%=ben.getId()%>"></td>
                    <td><%=index++%></td>
                   <%--  <td><%=bean.getId()%></td> --%>
                    <td><%=ben.getCollegeName()%></td>
                    <td><%=ben.getFirstName()%></td>
                    <td><%=ben.getLastName()%></td>
                    <td><%=ben.getDob()%></td>
                    <td><%=ben.getMobileNo()%></td>
                    <td><%=ben.getEmail()%></td>
