...
<%@page import="in.co.sunrays.proj4.servlet.SubjectCtl"%>
...
<div>	
	...
	<td><input type="text" name="name" placeholder="Enter Subject Name" size="24" value="<%=DataUtility.getStringData(bean.getSubjectName())%>">
