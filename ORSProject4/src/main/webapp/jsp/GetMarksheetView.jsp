...
<!DOCTYPE html>
<%@page import="in.co.sunrays.proj4.servlet.*"%>
...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
			...
			<table>
				<tr>
					<th align="right">RollNo <font color="red">*</font>:
					</th>
					</label>&emsp;
			...
			<table border="1" width="35%" cellpadding="5" cellspacing="0">
				<tr>
					...
					<td align="center"><%=DataUtility.getStringData(bean.getRollNo())%>
					</td>
