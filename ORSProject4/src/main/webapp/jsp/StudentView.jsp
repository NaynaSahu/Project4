...
<%@page import="in.co.sunrays.proj4.servlet.StudentCtl"%>
 ...
 <jsp:useBean id="bean" class="in.co.sunrays.proj4.bean.StudentBean" scope="request"></jsp:useBean>
	...
	<table>
	  ...
	  <tr><th style="padding: 3px"></th></tr>    	
		...
		<td><input type="text" name="firstname" placeholder="Enter First Name" size="24" value="<%=DataUtility.getStringData(bean.getFirstName())%>"></td>
		...
		<td><input type="text" name="lastname" placeholder="Enter Last Name" size="24" value="<%=DataUtility.getStringData(bean.getLastName())%>"></td>
		...
		<tr>
					...
					<td><input type="text" name="dob" id="datepicker"
						...
						value="<%=DataUtility.getDateString(bean.getDob())%>" size="24">
						&nbsp;<font style="position: fixed;" color="red"> <%=ServletUtility.getErrorMessage("dob", request)%></font></td>
				</tr>
						 <tr><th style="padding: 3px"></th></tr>    
		<tr>
		<th align="left">Mobile No <span style="color: red">*</span></th>
		<td><input type="text" name="mobile" maxlength="10" placeholder="Enter Mobile No" size="24" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
