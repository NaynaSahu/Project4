...
<%@page import="in.co.sunrays.proj4.servlet.MarksheetListCtl"%>
<%@page import="in.co.sunrays.proj4.servlet.BaseCtl"%>
			...
			<table width="100%">
				<tr>
					<td align="center"><label> Name :</label> <input type="text"
						...
						&emsp; <label>Roll No :</label> <%=HTMLUtility.getList("rollNo", String.valueOf(bean.getId()), roll)%>&emsp;
